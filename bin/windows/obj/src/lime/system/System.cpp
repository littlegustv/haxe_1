...
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_518___registerEntryPoint,"lime.system.System","__registerEntryPoint",0x78d55f5a,"lime.system.System.__registerEntryPoint","lime/system/System.hx",518,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_538___runProcess,"lime.system.System","__runProcess",0x7e9f5dfd,"lime.system.System.__runProcess","lime/system/System.hx",538,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_567_get_allowScreenTimeout,"lime.system.System","get_allowScreenTimeout",0x287e314e,"lime.system.System.get_allowScreenTimeout","lime/system/System.hx",567,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_578_set_allowScreenTimeout,"lime.system.System","set_allowScreenTimeout",0x5c29adc2,"lime.system.System.set_allowScreenTimeout","lime/system/System.hx",578,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_586_get_applicationDirectory,"lime.system.System","get_applicationDirectory",0xf6955c7f,"lime.system.System.get_applicationDirectory","lime/system/System.hx",586,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_599_get_applicationStorageDirectory,"lime.system.System","get_applicationStorageDirectory",0x34818fe0,"lime.system.System.get_applicationStorageDirectory","lime/system/System.hx",599,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_612_get_deviceModel,"lime.system.System","get_deviceModel",0x3a3e2ff1,"lime.system.System.get_deviceModel","lime/system/System.hx",612,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_643_get_deviceVendor,"lime.system.System","get_deviceVendor",0x99fb9840,"lime.system.System.get_deviceVendor","lime/system/System.hx",643,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_667_get_desktopDirectory,"lime.system.System","get_desktopDirectory",0x483b2773,"lime.system.System.get_desktopDirectory","lime/system/System.hx",667,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_680_get_documentsDirectory,"lime.system.System","get_documentsDirectory",0x4a6a8557,"lime.system.System.get_documentsDirectory","lime/system/System.hx",680,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_693_get_endianness,"lime.system.System","get_endianness",0x4df50bb4,"lime.system.System.get_endianness","lime/system/System.hx",693,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_716_get_fontsDirectory,"lime.system.System","get_fontsDirectory",0x8242b40b,"lime.system.System.get_fontsDirectory","lime/system/System.hx",716,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_732_get_numDisplays,"lime.system.System","get_numDisplays",0x5056f915,"lime.system.System.get_numDisplays","lime/system/System.hx",732,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_740_get_platformLabel,"lime.system.System","get_platformLabel",0xc2bb267f,"lime.system.System.get_platformLabel","lime/system/System.hx",740,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_763_get_platformName,"lime.system.System","get_platformName",0x82c4f420,"lime.system.System.get_platformName","lime/system/System.hx",763,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_804_get_platformVersion,"lime.system.System","get_platformVersion",0xbd9d7863,"lime.system.System.get_platformVersion","lime/system/System.hx",804,0x6434b429)
HX_LOCAL_STACK_FRAME(_hx_pos_f2b41f959dca9627_831_get_userDirectory,"lime.system.System","get_userDirectory",0x2b5522e0,"lime.system.System.get_userDirectory","lime/system/System.hx",831,0x6434b429)
...
HXLINE( 352)			::Sys_obj::command(HX_("start",62,74,0b,84),::Array_obj< ::String >::__new(1)->init(0,path));
            		}
            	}
...
void System_obj::_hx___registerEntryPoint(::String projectName, ::Dynamic entryPoint, ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_f2b41f959dca9627_518___registerEntryPoint)
HXLINE( 520)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___applicationConfig )) {
HXLINE( 522)			::lime::_hx_system::System_obj::_hx___applicationConfig =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE( 526)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___applicationEntryPoint )) {
HXLINE( 528)			::lime::_hx_system::System_obj::_hx___applicationEntryPoint =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE( 532)		::lime::_hx_system::System_obj::_hx___applicationEntryPoint->set(projectName,entryPoint);
HXLINE( 533)		::lime::_hx_system::System_obj::_hx___applicationConfig->set(projectName,config);
            	}
...
::String System_obj::_hx___runProcess(::String command,::Array< ::String > args){
            	HX_GC_STACKFRAME(&_hx_pos_f2b41f959dca9627_538___runProcess)
HXLINE( 541)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 543)			if (hx::IsNull( args )) {
HXLINE( 543)				args = ::Array_obj< ::String >::__new(0);
            			}
HXLINE( 545)			 ::sys::io::Process process =  ::sys::io::Process_obj::__alloc( HX_CTX ,command,args);
HXLINE( 546)			::String value = ::StringTools_obj::trim(process->_hx_stdout->readLine().toString());
HXLINE( 547)			process->close();
...
bool System_obj::get_allowScreenTimeout(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_567_get_allowScreenTimeout)
HXDLIN( 567)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_allow_screen_timeout();
            	}
...
bool System_obj::set_allowScreenTimeout(bool value){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_578_set_allowScreenTimeout)
HXDLIN( 578)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_set_allow_screen_timeout(value);
            	}
...
::String System_obj::get_applicationDirectory(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_586_get_applicationDirectory)
HXLINE( 588)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___applicationDirectory )) {
HXLINE( 590)			::lime::_hx_system::System_obj::_hx___applicationDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)0);
            		}
HXLINE( 594)		return ::lime::_hx_system::System_obj::_hx___applicationDirectory;
            	}
...
::String System_obj::get_applicationStorageDirectory(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_599_get_applicationStorageDirectory)
HXLINE( 601)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___applicationStorageDirectory )) {
HXLINE( 603)			::lime::_hx_system::System_obj::_hx___applicationStorageDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)1);
            		}
HXLINE( 607)		return ::lime::_hx_system::System_obj::_hx___applicationStorageDirectory;
            	}
...
::String System_obj::get_deviceModel(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_612_get_deviceModel)
HXLINE( 614)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___deviceModel )) {
HXLINE( 617)			::lime::_hx_system::System_obj::_hx___deviceModel = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_device_model()) );
            		}
HXLINE( 638)		return ::lime::_hx_system::System_obj::_hx___deviceModel;
            	}
...
::String System_obj::get_deviceVendor(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_643_get_deviceVendor)
HXLINE( 645)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___deviceVendor )) {
HXLINE( 648)			::lime::_hx_system::System_obj::_hx___deviceVendor = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_device_vendor()) );
            		}
HXLINE( 662)		return ::lime::_hx_system::System_obj::_hx___deviceVendor;
            	}
...
::String System_obj::get_desktopDirectory(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_667_get_desktopDirectory)
HXLINE( 669)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___desktopDirectory )) {
HXLINE( 671)			::lime::_hx_system::System_obj::_hx___desktopDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)2);
            		}
HXLINE( 675)		return ::lime::_hx_system::System_obj::_hx___desktopDirectory;
            	}
...
::String System_obj::get_documentsDirectory(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_680_get_documentsDirectory)
HXLINE( 682)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___documentsDirectory )) {
HXLINE( 684)			::lime::_hx_system::System_obj::_hx___documentsDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)3);
            		}
HXLINE( 688)		return ::lime::_hx_system::System_obj::_hx___documentsDirectory;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(System_obj,get_documentsDirectory,return )
 ...
 ::lime::_hx_system::Endian System_obj::get_endianness(){
            	HX_GC_STACKFRAME(&_hx_pos_f2b41f959dca9627_693_get_endianness)
HXLINE( 695)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___endianness )) {
HXLINE( 700)			 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc((int)2);
HXDLIN( 700)			 ::haxe::io::Bytes arrayBuffer = this1;
HXLINE( 701)			 ::lime::utils::ArrayBufferView this2;
HXDLIN( 701)			if (hx::IsNotNull( arrayBuffer )) {
HXLINE( 701)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 701)				int in_byteOffset = (int)0;
HXDLIN( 701)				if ((in_byteOffset < (int)0)) {
HXLINE( 701)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 701)				if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 701)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 701)				int bufferByteLength = arrayBuffer->length;
HXDLIN( 701)				int elementSize = _this->bytesPerElement;
HXDLIN( 701)				int newByteLength = bufferByteLength;
HXDLIN( 701)				{
HXLINE( 701)					newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN( 701)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 701)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 701)					if ((newByteLength < (int)0)) {
HXLINE( 701)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 701)				_this->buffer = arrayBuffer;
HXDLIN( 701)				_this->byteOffset = in_byteOffset;
HXDLIN( 701)				_this->byteLength = newByteLength;
HXDLIN( 701)				_this->length = ::Std_obj::_hx_int(((Float)newByteLength / (Float)_this->bytesPerElement));
HXDLIN( 701)				this2 = _this;
            			}
            			else {
HXLINE( 701)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            			}
HXDLIN( 701)			 ::lime::utils::ArrayBufferView uint8Array = this2;
HXLINE( 702)			 ::lime::utils::ArrayBufferView this3;
HXDLIN( 702)			if (hx::IsNotNull( arrayBuffer )) {
HXLINE( 702)				 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)6);
HXDLIN( 702)				int in_byteOffset1 = (int)0;
HXDLIN( 702)				if ((in_byteOffset1 < (int)0)) {
HXLINE( 702)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 702)				if ((hx::Mod(in_byteOffset1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 702)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 702)				int bufferByteLength1 = arrayBuffer->length;
HXDLIN( 702)				int elementSize1 = _this1->bytesPerElement;
HXDLIN( 702)				int newByteLength1 = bufferByteLength1;
HXDLIN( 702)				{
HXLINE( 702)					newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 702)					if ((hx::Mod(bufferByteLength1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 702)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 702)					if ((newByteLength1 < (int)0)) {
HXLINE( 702)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 702)				_this1->buffer = arrayBuffer;
HXDLIN( 702)				_this1->byteOffset = in_byteOffset1;
HXDLIN( 702)				_this1->byteLength = newByteLength1;
HXDLIN( 702)				_this1->length = ::Std_obj::_hx_int(((Float)newByteLength1 / (Float)_this1->bytesPerElement));
HXDLIN( 702)				this3 = _this1;
            			}
            			else {
HXLINE( 702)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt16Array",0a,c7,2d,d5));
            			}
HXDLIN( 702)			 ::lime::utils::ArrayBufferView uint16array = this3;
HXLINE( 703)			::__hxcpp_memory_set_byte(uint8Array->buffer->b,uint8Array->byteOffset,(int)170);
HXLINE( 704)			::__hxcpp_memory_set_byte(uint8Array->buffer->b,(uint8Array->byteOffset + (int)1),(int)187);
HXLINE( 705)			if ((((int)::__hxcpp_memory_get_ui16(uint16array->buffer->b,uint16array->byteOffset) & (int)(int)65535) == (int)43707)) {
HXLINE( 705)				::lime::_hx_system::System_obj::_hx___endianness = ::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn();
            			}
            			else {
HXLINE( 706)				::lime::_hx_system::System_obj::_hx___endianness = ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            			}
            		}
HXLINE( 711)		return ::lime::_hx_system::System_obj::_hx___endianness;
            	}
...
::String System_obj::get_fontsDirectory(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_716_get_fontsDirectory)
HXLINE( 718)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___fontsDirectory )) {
HXLINE( 720)			::lime::_hx_system::System_obj::_hx___fontsDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)4);
            		}
HXLINE( 724)		return ::lime::_hx_system::System_obj::_hx___fontsDirectory;
            	}
...
int System_obj::get_numDisplays(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_732_get_numDisplays)
HXDLIN( 732)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_num_displays();
            	}
...
::String System_obj::get_platformLabel(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_740_get_platformLabel)
HXLINE( 742)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___platformLabel )) {
HXLINE( 745)			::String label = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_platform_label()) );
HXLINE( 746)			if (hx::IsNotNull( label )) {
HXLINE( 746)				::lime::_hx_system::System_obj::_hx___platformLabel = ::StringTools_obj::trim(label);
            			}
            		}
HXLINE( 758)		return ::lime::_hx_system::System_obj::_hx___platformLabel;
            	}
...
::String System_obj::get_platformName(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_763_get_platformName)
HXLINE( 765)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___platformName )) {
HXLINE( 768)			::lime::_hx_system::System_obj::_hx___platformName = HX_("Windows",63,06,c6,b5);
            		}
HXLINE( 799)		return ::lime::_hx_system::System_obj::_hx___platformName;
            	}
...
::String System_obj::get_platformVersion(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_804_get_platformVersion)
HXLINE( 806)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___platformVersion )) {
HXLINE( 809)			::lime::_hx_system::System_obj::_hx___platformVersion = ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_system_get_platform_version()) );
            		}
HXLINE( 826)		return ::lime::_hx_system::System_obj::_hx___platformVersion;
            	}
...
::String System_obj::get_userDirectory(){
            	HX_STACKFRAME(&_hx_pos_f2b41f959dca9627_831_get_userDirectory)
HXLINE( 833)		if (hx::IsNull( ::lime::_hx_system::System_obj::_hx___userDirectory )) {
HXLINE( 835)			::lime::_hx_system::System_obj::_hx___userDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)5);
            		}
HXLINE( 839)		return ::lime::_hx_system::System_obj::_hx___userDirectory;
            	}
