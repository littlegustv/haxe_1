...
HXLINE(  23)		::String projectName = HX_("newproject",79,0e,9c,65);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("Your name here",58,65,f5,7d))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("44",80,2d,00,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(22)
            				...
            				->setFixed(9,HX_("height",e7,07,4c,02),(int)360)
            				->setFixed(10,HX_("title",98,15,3b,10),HX_("New Project",d9,46,e8,18))
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.yournamehere.newproject",4c,27,65,04))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("newproject",79,0e,9c,65))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("New Project",d9,46,e8,18))
