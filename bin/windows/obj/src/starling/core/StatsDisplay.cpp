...
HXLINE( 128)		this->_hx___memory = (::openfl::_hx_system::System_obj::get_totalMemory() * ((Float)9.5367431640625e-007));
HXLINE( 129)		Float _hx_tmp3;
HXDLIN( 129)		if (this->get_supportsGpuMem()) {
HXLINE( 129)			_hx_tmp3 = (::Reflect_obj::field(::starling::core::Starling_obj::get_current()->get_context(),HX_("totalGPUMemory",e9,89,1b,9c)) * ((Float)9.5367431640625e-007));
            		}
            		else {
